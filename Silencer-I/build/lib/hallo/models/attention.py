...
class AudioTemporalBasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        """
        # print('timestep: ', timestep) # None
        norm_hidden_states = (
            self.norm1(hidden_states, timestep)
            if self.use_ada_layer_norm
            else self.norm1(hidden_states)
        )
        # print('norm_hidden_states: ', norm_hidden_states.shape) # 32, 4096, 320
        ...
        if self.attn2 is not None:
            ...
            # print('encoder_hidden_states: ', encoder_hidden_states.shape) # 32, 32, 768
