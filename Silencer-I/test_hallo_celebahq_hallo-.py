...
allfolders = glob(f'./protect/out_celebahq_512/hallo_eps16_steps100_gmode-_200*') ### epsilon 16
print(allfolders)
allfolders.sort()
allimgs = glob(allfolders[prefix]+'/celebahq_512/*')
baselinename = os.path.basename(allfolders[prefix])
outpath = f'./talking_output/celebahq_{baselinename}/'
