...
class CrossAttnDownBlock3D(nn.Module):
    ...
    def __init__(
        ...
        for i in range(num_layers):
            ...
            # print(attn_num_head_channels)
            # print(in_channels // attn_num_head_channels)
            # print('in_channels', out_channels)
            # print('num_layers', 1)
            # print('cross_attention_dim', audio_attention_dim)
            # print('norm_num_groups', resnet_groups)
            ...
            # print('use_audio_module', use_audio_module)
            # print('depth', depth)
            # print('unet_block_name', "down")
            # print('stack_enable_blocks_name', stack_enable_blocks_name)
            # print('stack_enable_blocks_depth', stack_enable_blocks_depth)
        ...
        for _, (resnet, attn, audio_module, motion_module) in enumerate(
            ...
            if self.training and self.gradient_checkpointing:
                ...
                if audio_module is not None:
                    ...
                    # print(audio_embedding.shape) # 2, 16, 32, 768
