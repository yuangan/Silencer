...
import sys
# sys.path.append('/home/gy/code/protect/DiffAttack')
# from utils import show_cross_attention_hallo
...
class FaceAnimatePipeline(DiffusionPipeline):
    ...
    def prepare_latents(
        ...
        # print('self.scheduler.init_noise_sigma: ', self.scheduler.init_noise_sigma) # self.scheduler.init_noise_sigma:  1.0
    ...
    def __call__(
        ...
        **kwargs,
        ...
        do_classifier_free_guidance = guidance_scale > 1.0 # 3.5, True
        ...
        # print(latents.shape) # 1, 4, 16, 64, 64

        # Prepare extra step kwargs.
        extra_step_kwargs = self.prepare_extra_step_kwargs(generator, eta)
        
        # print(ref_image.shape) # [1, 3, 3, 512, 512]
        ...
        # print(face_mask.shape) # 1, 3, 512, 512
        ...
        # print(audio_tensor.shape) # [2, 16, 32, 768]
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # show_cross_attention_hallo(controller, res=32, from_where=("down",),
                #         save_path=r"./talking_output/CrossAttentionHallo.jpg", num_rows=32)
                # assert(0)
                # perform guidance
                if do_classifier_free_guidance:
        ...
        # print(images.shape) # [1 3 16 512 512]
